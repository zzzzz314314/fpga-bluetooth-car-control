package com.myandroid.controler;
...
public class MainActivity extends AppCompatActivity {
    ...
    private Button button_up, button_down, button_stop, button_left, button_right, button_auto, button_manual;
        ...
        mHandler = new Handler(){
            public void handleMessage(android.os.Message msg){
                if(msg.what == MESSAGE_READ){ //收到MESSAGE_READ 開始接收資料
                    ...
                    //readMessage = Double.parseDouble(inputdata.getText().toString());
                    //mReadBuffer.setText("" + readMessage); //將收到的字串呈現在畫面上
           ...
           button_up.setOnClickListener(new View.OnClickListener(){
            ...
            /*button_manual.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    _recieveData = ""; //清除上次收到的資料
                    if(mConnectedThread != null){    //First check to make sure thread created
                        mConnectedThread.write("fuck"); // 14
                    }
                }
            });
